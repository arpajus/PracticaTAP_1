...
public class MainPolicyRoundRobin {
    ...
    public static void main(String[] args) {
         ...
         * Swaps between one and the other:
         * Invoker 1: add1, add2_1
         * Invoker 2: add2_0, add2_2, f5
         */
         ...
         * It will try to distribute as it follows:
         * Swaps between one and the other:
         * Invoker 1: add1, add2_1, add3
         * Invoker 2: add2_0, add2_2, f5, add4
         */
        if (controller.distributeActions()) {
    ...
    private static boolean distributeActionsOk1() {
        ...
        return controller.getInvokerById("1").getActions().get(0).getId().equals("add1") &&
                controller.getInvokerById("2").getActions().get(0).getId().equals("add2_0") &&
                controller.getInvokerById("1").getActions().get(1).getId().equals("add2_1") &&
                controller.getInvokerById("2").getActions().get(1).getId().equals("add2_2") &&
                controller.getInvokerById("2").getActions().get(2).getId().equals("mul5") &&
                controller.getInvokerById("1").getActions().size() == 2 &&
                controller.getInvokerById("2").getActions().size() == 3 &&
                controller.getInvokerById("1").getTotalMemory() == 400 &&
                controller.getInvokerById("2").getTotalMemory() == 500;
    }
    ...
    private static boolean distributeActionsOk2() {
        ...
        return controller.getInvokerById("1").getActions().get(0).getId().equals("add1") &&
                ...
                controller.getInvokerById("2").getActions().get(1).getId().equals("add2_2") &&
                controller.getInvokerById("2").getActions().get(2).getId().equals("mul5") &&
                controller.getInvokerById("1").getActions().get(2).getId().equals("add3") &&
                controller.getInvokerById("2").getActions().get(3).getId().equals("mul4") &&
                controller.getInvokerById("1").getActions().size() == 3 &&
                controller.getInvokerById("2").getActions().size() == 4 &&
                controller.getInvokerById("1").getTotalMemory() == 300 &&
                controller.getInvokerById("2").getTotalMemory() == 400;
    }
