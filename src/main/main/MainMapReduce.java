...
public class MainMapReduce {
    public static void main(String[] args) {
        ...
        System.out.println("Resultado total del conteo de palabras: " + totalCountWords);
        System.out.println("Resultado total del conteo de frecuencia de palabras: " + totalWordCounts);
    }
